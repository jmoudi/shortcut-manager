...
;;(xbindkey '(control shift x) "xdotool type dsfsfsf")

(xbindkey '(control shift a) "xdotool")
...
(xbindkey-function '(control shift h)
		   (lambda ()
		     (run-command "xterm")))

(xbindkey-function '(control shift z)
		   (lambda ()
		     (run-command "xdotool type d")))

(xbindkey-function '(control shift x)
		   (lambda ()
